...
const links = [
  { to: "/candidate/dashboard",    label: "My Dashboard",   icon: "📊" },
  { to: "/candidate/applications", label: "My Applications",icon: "📋" },
  { to: "/candidate/interviews",   label: "My Interviews",  icon: "🎙️" },
  ...
  return (
    <aside className="w-64 min-h-screen bg-blue-900 text-white flex flex-col">
      <div className="p-6 border-b border-blue-800">
        ...
        <p className="text-xs text-blue-300 mt-1">Candidate Portal</p>
      </div>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-blue-300">Candidate</p>
          </div>
        </div>
      </div>
